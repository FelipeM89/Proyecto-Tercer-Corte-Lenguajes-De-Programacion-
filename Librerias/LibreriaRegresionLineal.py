...
class regresion_lineal_ascii:
    ...
    def render_ascii_regression(self,
        ...
        """
        Renderiza un gráfico ASCII con puntos (x,y) y la recta de regresión y = m x + b.
        ...
        - line_char: carácter para representar la línea de regresión.
        ...
        for i in range(sample_count):
            ...
            # Opcional: conectar con el punto anterior (dibujar líneas horizontales simples)
            if prev_col is not None and prev_row is not None:
                ...
                if prev_row == row:
                    ...
                    # simple diagonal approx: mark the two cells
                    if grid[row][col] == ' ':
                        grid[row][col] = line_char
...
def main():
    ...
    print(art)
    # También mostrar métricas debajo
    print()
